...
//So in theory this is going to detect objects that it's looking at and put cylinders around them
//In the future this can be updated to take our perception data and put boxes/cylinders around obstacles
...
public:
  SceneUpdater()
  {
    ...
    ros::Subscriber sub = nh.subscribe("/hsrb/head_rgbd_sensor/depth_registered/image_raw", 1, &SceneUpdater::cloudCB, this);
    // Spin
    ros::spin();
  }
  ...
  void addCylinder()
  {
    ...
    collision_object.header.frame_id = "whole_body";
